package com.yunis.facedetection
        ...
        btn.setOnClickListener {
            ...
            val result = detector.process(image)
                .addOnSuccessListener { faces ->
                    ...
                    // ...
                    val toast = Toast.makeText(applicationContext, "Face detected", Toast.LENGTH_SHORT)
                    toast.show()
                    bitmap.apply{
                ...
                .addOnFailureListener { e ->
                    ...
                    // ...
                    val toast = Toast.makeText(applicationContext, "No face detected", Toast.LENGTH_SHORT)
                    toast.show()
                }
